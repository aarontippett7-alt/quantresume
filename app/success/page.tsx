  ...
  if (loading) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 text-white">
        ...
        <h2 className="text-2xl font-bold">Quant Analysis in Progress...</h2>
        <p className="mt-2 text-slate-400">Surgically engineering your documents.</p>
      </div>
    );
  }
              ...
              <div className="p-8">
                <div className="mb-6 flex items-center justify-between">
                  <h3 className="text-lg font-bold text-white">
                    {activeTab === 'resume' ? 'Engineered Resume Text' : 'Surgical Cover Letter'}
                  </h3>
                  <button
